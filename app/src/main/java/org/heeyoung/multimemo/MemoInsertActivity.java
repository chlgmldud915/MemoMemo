...
import org.heeyoung.multimemo.common.TitleBackgroundButton;
...
public class MemoInsertActivity extends Activity {
	...
	public void setMediaImage(String photoId, String photoUri) {
    	...
    	if(photoId.equals("") || photoId.equals("-1")) {
			...
			Log.e(TAG, "set ima"+Uri.parse(BasicInfo.FOLDER_PHOTO + photoUri));
    ...
    private void saveInput() {
		...
		SQL = "insert into " + MemoDatabase.TABLE_MEMO + "( INPUT_DATE, CONTENT_TEXT, ID_PHOTO ) values( " + " DATETIME('" + mDateStr + "'), " + "'"+ mMemoStr + "', "+"'"+ photoId + "'" +")";
